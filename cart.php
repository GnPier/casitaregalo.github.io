...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="Eliminar producto" onclick="return confirm('¿eliminar producto del carrito?');" class="delete-btn" name="delete">
   </form>
   <?php
   ...
   <div class="cart-total">
      <p>Total a pagar : <span>S/<?= $grand_total; ?></span></p>
      <a href="shop.php" class="option-btn">Continuar comprando</a>
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('delete all from cart?');">Eliminar todos los prodcutos</a>

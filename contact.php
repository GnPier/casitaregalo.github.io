...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" min="0" max="999999999" placeholder="Ingresa tu numero de celular" required onkeypress="if(this.value.length == 9) return false;" class="box">
      <textarea name="msg" class="box" placeholder="Dinos tu mensaje" cols="30" rows="10"></textarea>
